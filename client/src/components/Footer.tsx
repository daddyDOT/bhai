...
const Subscribe = () => {
  return (
    <section id="footer" className="bg-[#263387]">
            ...
            <div className="flex gap-5 text-white">
              <div>
                ...
                <p className="text-xl w-[300px]">
                  ...
                  dokumentovanje naučno-istraživačkih aktivnosti svih
                  istraživača BH porijekla.
                </p>
              </div>
              <div>
                <h1 className="text-xl font-semibold mb-10">
                ...
                <p className="text-xl w-[300px]">
                  Sve osobe BH porijekla koje imaju barem jednu naučnu
                  publikaciju su dobrodošle da se prijave na BH akademski
                  imenik.
                </p>
              </div>
              <div>
