...
for publication_id, description in publications:
    ...
    #sql="UPDATE publications SET bionic_description = '{new_text}' WHERE publication_id = {publication_id};"
    #HERE INSTEAD OF THIS LINE INSERT new_words into bionic_text col for publ with this id 
    new_words = []
