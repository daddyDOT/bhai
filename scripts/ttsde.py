...
def process_publications():
    ...
    select_query = "SELECT publications.publication_id, content FROM translations INNER JOIN publications ON publications.publication_id = translations.publication_id WHERE translations.language = 'German';"
